...
# -Seis amigos partem de estados diferentes
# -Destino GRU, São Paulo
# -Objetivo é chegarem em horários próximos e dividir o custo do transporte
...
def funcao_custo(solucao):
    ...
    #penalidade, se verdade pegaram voo no dia seguinte
    if ultima_chegada > primeira_partida:
        preco_total += 50 

    return preco_total + total_espera
    #total_espera equivale a R$ 1 / minuto
